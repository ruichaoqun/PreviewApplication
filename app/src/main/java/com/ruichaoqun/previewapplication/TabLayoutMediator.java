...
public final class TabLayoutMediator {
  @NonNull private final VjiaTabLayout tabLayout;
  ...
  @Nullable private VjiaTabLayout.OnTabSelectedListener onTabSelectedListener;
  ...
  public interface TabConfigurationStrategy {
     ...
     */
    void onConfigureTab(@NonNull VjiaTabLayout.Tab tab, int position);
  }

  public TabLayoutMediator(
      @NonNull VjiaTabLayout tabLayout,
  ...
  void populateTabsFromPagerAdapter() {
    ...
    if (adapter != null) {
      ...
      for (int i = 0; i < adapterCount; i++) {
        VjiaTabLayout.Tab tab = tabLayout.newTab();
  ...
  private static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
    ...
    TabLayoutOnPageChangeCallback(VjiaTabLayout tabLayout) {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
      VjiaTabLayout tabLayout = tabLayoutRef.get();
      if (tabLayout != null) {
   ...
   */
  private static class ViewPagerOnTabSelectedListener implements VjiaTabLayout.OnTabSelectedListener {
